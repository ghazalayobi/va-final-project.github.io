  ...
  d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_hist.csv").then( function(data) {
    ...
    const svg = d3.select("#amphet-description")
    .append("svg")
  ...
  // Add the path using this helper function
    ...
    .text('Personality Scores Analysis of Amphetamine Users');

    var text1 = "Analyzing personality scores of amphetamine users. \n The section covers personality score distribution among gender, average scores by age and education, and a radar chart showing average scores \n of amphet users and the period when they last use amphet.";
...
svg.append("text")
  ...
  .style("font-size", "20px") 
  .style("text-decoration", "underline")
  .text('What is Amphetamine?');

  var text2 = "Amphetamine is a central nervous system stimulant drug that increases activity and wakefulness in the brain. It is commonly used  \n to treat attention deficit hyperactivity disorder (ADHD) and narcolepsy, but is also abused recreationally for its euphoric effects."
  svg.append("text")
  .attr("x", 0)
  .attr("y", 190)
  .style("font-size", "14px")
...

{
  ...
  return d.variable === "oscore" && d.gender === "F" && d.drug_type === "amphet"
  }));
  const bins2 = histogram(data.filter( function(d){
  return d.variable === "cscore" && d.gender === "F" && d.drug_type === "amphet"
  }));
  const bins3 = histogram(data.filter( function(d){
  return d.variable === "escore" && d.gender === "F" && d.drug_type === "amphet"
  }));
  const bins4 = histogram(data.filter( function(d){
  return d.variable === "ascore" && d.gender === "F" && d.drug_type === "amphet"
  }));
  const bins5 = histogram(data.filter( function(d){
  return d.variable === "nscore" && d.gender === "F" && d.drug_type === "amphet"
  }));
...
// this codde is done for multiple hisograms 
  ...
  // And apply twice this function to data to get the bins.
  const bins1 = histogram(data.filter( function(d){
  return d.variable === "oscore" && d.gender === "M" && d.drug_type === "amphet"
  }));
  const bins2 = histogram(data.filter( function(d){
  return d.variable === "cscore" && d.gender === "M" && d.drug_type === "amphet"
  }));
  const bins3 = histogram(data.filter( function(d){
  return d.variable === "escore" && d.gender === "M" && d.drug_type === "amphet"
  }));
  const bins4 = histogram(data.filter( function(d){
  return d.variable === "ascore" && d.gender === "M" && d.drug_type === "amphet"
  }));
  const bins5 = histogram(data.filter( function(d){
  return d.variable === "nscore" && d.gender === "M" && d.drug_type === "amphet"
  }));
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'amphet').filter(d => d.variable === 'oscore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'amphet').filter(d => d.variable === 'cscore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'amphet').filter(d => d.variable === 'escore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'amphet').filter(d => d.variable === 'ascore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'amphet').filter(d => d.variable === 'nscore');
...
/////////////////////////////////////////
  ...
  var o_data = [
    [
      {axis:"Last_Day",value:3.63, drug_type: 'amphet', gender: 'F', variable: 'oscore'},
      {axis:"Last_Decade",value:3.52, drug_type: 'amphet', gender: 'F', variable: 'oscore'},
      {axis:"Last_Month",value:3.53, drug_type: 'amphet', gender: 'F', variable: 'oscore'},
      {axis:"Last_Week",value:4.16, drug_type: 'amphet', gender: 'F', variable: 'oscore'},
      {axis:"Last_Year",value:4.0, drug_type: 'amphet', gender: 'F', variable: 'oscore'},
      ],[
      {axis:"Last_Day",value:3.67, drug_type: 'amphet', gender: 'M', variable: 'oscore'},
      {axis:"Last_Decade",value:3.68, drug_type: 'amphet', gender: 'M', variable: 'oscore'},
      {axis:"Last_Month",value:3.83, drug_type: 'amphet', gender: 'M', variable: 'oscore'},
      {axis:"Last_Week",value:3.87, drug_type: 'amphet', gender: 'M', variable: 'oscore'},
      {axis:"Last_Year",value:3.93, drug_type: 'amphet', gender: 'M', variable: 'oscore'},
      ]
  ];
  ...
  var c_data = [
    ...
    [
      {axis:"Last_Day",value:2.89, drug_type: 'amphet', gender: 'F', variable: 'cscore'},
      {axis:"Last_Week",value:3.40, drug_type: 'amphet', gender: 'F', variable: 'cscore'},
      {axis:"Last_Month",value:3.00, drug_type: 'amphet', gender: 'F', variable: 'cscore'},
      {axis:"Last_Year",value:2.94, drug_type: 'amphet', gender: 'F', variable: 'cscore'},
      {axis:"Last_Decade",value:3.35, drug_type: 'amphet', gender: 'F', variable: 'cscore'},
      ],[
      {axis:"Last_Day",value:3.14, drug_type: 'amphet', gender: 'M', variable: 'cscore'},
      {axis:"Last_Week",value:3.29, drug_type: 'amphet', gender: 'M', variable: 'cscore'},
      {axis:"Last_Month",value:2.92, drug_type: 'amphet', gender: 'M', variable: 'cscore'},
      {axis:"Last_Year",value:2.95, drug_type: 'amphet', gender: 'M', variable: 'cscore'},
      {axis:"Last_Decade",value:3.09, drug_type: 'amphet', gender: 'M', variable: 'cscore'},
      ]
  ];
  
  var e_data = [
    [
      {axis:"Last_Day",value:3.37, drug_type: 'amphet', gender: 'F', variable: 'escore'},
      {axis:"Last_Week",value:3.62, drug_type: 'amphet', gender: 'F', variable: 'escore'},
      {axis:"Last_Month",value:3.24, drug_type: 'amphet', gender: 'F', variable: 'escore'},
      {axis:"Last_Year",value:3.28, drug_type: 'amphet', gender: 'F', variable: 'escore'},
      {axis:"Last_Decade",value:3.6, drug_type: 'amphet', gender: 'F', variable: 'escore'},
      ],[
      {axis:"Last_Day",value:3.2, drug_type: 'amphet', gender: 'M', variable: 'escore'},
      {axis:"Last_Week",value:3.36, drug_type: 'amphet', gender: 'M', variable: 'escore'},
      {axis:"Last_Month",value:3.59, drug_type: 'amphet', gender: 'M', variable: 'escore'},
      {axis:"Last_Year",value:3.46, drug_type: 'amphet', gender: 'M', variable: 'escore'},
      {axis:"Last_Decade",value:3.4, drug_type: 'amphet', gender: 'M', variable: 'escore'},
      ]
  ];
  ...
  var a_data = [
    ...
    [
      {axis:"Last_Day",value:3.41, drug_type: 'amphet', gender: 'F', variable: 'ascore'},
      {axis:"Last_Week",value:3.75, drug_type: 'amphet', gender: 'F', variable: 'ascore'},
      {axis:"Last_Month",value:3.18, drug_type: 'amphet', gender: 'F', variable: 'ascore'},
      {axis:"Last_Year",value:3.13, drug_type: 'amphet', gender: 'F', variable: 'ascore'},
      {axis:"Last_Decade",value:3.57, drug_type: 'amphet', gender: 'F', variable: 'ascore'},
  ],[
      {axis:"Last_Day",value:2.97, drug_type: 'amphet', gender: 'M', variable: 'ascore'},
      {axis:"Last_Week",value:3.27, drug_type: 'amphet', gender: 'M', variable: 'ascore'},
      {axis:"Last_Month",value:3.05, drug_type: 'amphet', gender: 'M', variable: 'ascore'},
      {axis:"Last_Year",value:3.16, drug_type: 'amphet', gender: 'M', variable: 'ascore'},
      {axis:"Last_Decade",value:3.21, drug_type: 'amphet', gender: 'M', variable: 'ascore'},
      ]
  ...
  var n_data = [
    ...
    [
      {axis:"Last_Day",value:3.81, drug_type: 'amphet', gender: 'F', variable: 'nscore'},
      {axis:"Last_Week",value:3.63, drug_type: 'amphet', gender: 'F', variable: 'nscore'},
      {axis:"Last_Month",value:4.18, drug_type: 'amphet', gender: 'F', variable: 'nscore'},
      {axis:"Last_Year",value:3.8, drug_type: 'amphet', gender: 'F', variable: 'nscore'},
      {axis:"Last_Decade",value:3.78, drug_type: 'amphet', gender: 'F', variable: 'nscore'},
  
      ],[
      {axis:"Last_Day",value:3.64, drug_type: 'amphet', gender: 'M', variable: 'nscore'},
      {axis:"Last_Decade",value:3.39, drug_type: 'amphet', gender: 'M', variable: 'nscore'},
      {axis:"Last_Month",value:3.56, drug_type: 'amphet', gender: 'M', variable: 'nscore'},
      {axis:"Last_Week",value:3.77, drug_type: 'amphet', gender: 'M', variable: 'nscore'},
      {axis:"Last_Year",value:3.58, drug_type: 'amphet', gender: 'M', variable: 'nscore'},
      ]
