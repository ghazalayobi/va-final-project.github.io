  ...
  d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_hist.csv").then( function(data) {
    ...
    const svg = d3.select("#cannabis-description")
    .append("svg")
  ...
  // Add the path using this helper function
    ...
    .text('Personality Scores Analysis of Cannabis or Marijuana Users');

    var text1 = "Analyzing personality scores of cannabis users. \n The section covers personality score distribution among gender, average scores by age and education, and a radar chart showing average scores \n of cannabis users and the period when they last use cannabis.";
...
svg.append("text")
  ...
  .style("font-size", "20px") 
  .style("text-decoration", "underline")
  .text('What is Cannabis or Marijuana?');

  var text2 = "Cannabis is a drug derived from the Cannabis plant that is used for medicinal and recreational purposes. It contains compounds like \n THC (tetrahydrocannabinol) and CBD (cannabidiol) that can produce effects such as relaxation, altered perceptions, and increased appetite. \n In many countries, its use is regulated or prohibited by law"
  svg.append("text")
  .attr("x", 0)
  .attr("y", 190)
  .style("font-size", "14px")
...

{
  ...
  return d.variable === "oscore" && d.gender === "F" && d.drug_type === "cannabis"
  }));
  const bins2 = histogram(data.filter( function(d){
  return d.variable === "cscore" && d.gender === "F" && d.drug_type === "cannabis"
  }));
  const bins3 = histogram(data.filter( function(d){
  return d.variable === "escore" && d.gender === "F" && d.drug_type === "cannabis"
  }));
  const bins4 = histogram(data.filter( function(d){
  return d.variable === "ascore" && d.gender === "F" && d.drug_type === "cannabis"
  }));
  const bins5 = histogram(data.filter( function(d){
  return d.variable === "nscore" && d.gender === "F" && d.drug_type === "cannabis"
  }));
...
// this codde is done for multiple hisograms 
  ...
  // And apply twice this function to data to get the bins.
  const bins1 = histogram(data.filter( function(d){
  return d.variable === "oscore" && d.gender === "M" && d.drug_type === "cannabis"
  }));
  const bins2 = histogram(data.filter( function(d){
  return d.variable === "cscore" && d.gender === "M" && d.drug_type === "cannabis"
  }));
  const bins3 = histogram(data.filter( function(d){
  return d.variable === "escore" && d.gender === "M" && d.drug_type === "cannabis"
  }));
  const bins4 = histogram(data.filter( function(d){
  return d.variable === "ascore" && d.gender === "M" && d.drug_type === "cannabis"
  }));
  const bins5 = histogram(data.filter( function(d){
  return d.variable === "nscore" && d.gender === "M" && d.drug_type === "cannabis"
  }));
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'cannabis').filter(d => d.variable === 'oscore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'cannabis').filter(d => d.variable === 'cscore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'cannabis').filter(d => d.variable === 'escore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'cannabis').filter(d => d.variable === 'ascore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'cannabis').filter(d => d.variable === 'nscore');
...
/////////////////////////////////////////
  ...
  var o_data = [
      ...
      [
        {axis:"Last_Day",value:4.04, drug_type: 'cannabis', gender: 'F', variable: 'oscore'},
        {axis:"Last_Decade",value:3.26, drug_type: 'cannabis', gender: 'F', variable: 'oscore'},
        {axis:"Last_Month",value:3.67, drug_type: 'cannabis', gender: 'F', variable: 'oscore'},
        {axis:"Last_Week",value:3.96, drug_type: 'cannabis', gender: 'F', variable: 'oscore'},
        {axis:"Last_Year",value:3.56, drug_type: 'cannabis', gender: 'F', variable: 'oscore'},
    ],[
        {axis:"Last_Day",value:3.89, drug_type: 'cannabis', gender: 'M', variable: 'oscore'},
        {axis:"Last_Decade",value:3.23, drug_type: 'cannabis', gender: 'M', variable: 'oscore'},
        {axis:"Last_Month",value:3.75, drug_type: 'cannabis', gender: 'M', variable: 'oscore'},
        {axis:"Last_Week",value:3.86, drug_type: 'cannabis', gender: 'M', variable: 'oscore'},
        {axis:"Last_Year",value:3.59, drug_type: 'cannabis', gender: 'M', variable: 'oscore'},
    ]
  ...
  var c_data = [
    [
      {axis:"Last_Day",value:3.25, drug_type: 'cannabis', gender: 'F', variable: 'cscore'},
      {axis:"Last_Decade",value:3.67, drug_type: 'cannabis', gender: 'F', variable: 'cscore'},
      {axis:"Last_Month",value:3.3, drug_type: 'cannabis', gender: 'F', variable: 'cscore'},
      {axis:"Last_Week",value:3.35, drug_type: 'cannabis', gender: 'F', variable: 'cscore'},
      {axis:"Last_Year",value:3.36, drug_type: 'cannabis', gender: 'F', variable: 'cscore'},
      ],[
      {axis:"Last_Day",value:3.17, drug_type: 'cannabis', gender: 'M', variable: 'cscore'},
      {axis:"Last_Decade",value:3.34, drug_type: 'cannabis', gender: 'M', variable: 'cscore'},
      {axis:"Last_Month",value:3.01, drug_type: 'cannabis', gender: 'M', variable: 'cscore'},
      {axis:"Last_Week",value:3.18, drug_type: 'cannabis', gender: 'M', variable: 'cscore'},
      {axis:"Last_Year",value:3.07, drug_type: 'cannabis', gender: 'M', variable: 'cscore'},
      ]
  ...
  var e_data = [
    [
      {axis:"Last_Day",value:3.5, drug_type: 'cannabis', gender: 'F', variable: 'escore'},
      {axis:"Last_Decade",value:3.54, drug_type: 'cannabis', gender: 'F', variable: 'escore'},
      {axis:"Last_Month",value:3.66, drug_type: 'cannabis', gender: 'F', variable: 'escore'},
      {axis:"Last_Week",value:3.46, drug_type: 'cannabis', gender: 'F', variable: 'escore'},
      {axis:"Last_Year",value:3.53, drug_type: 'cannabis', gender: 'F', variable: 'escore'},
      ] ,[
      {axis:"Last_Day",value:3.47, drug_type: 'cannabis', gender: 'M', variable: 'escore'},
      {axis:"Last_Decade",value:3.21, drug_type: 'cannabis', gender: 'M', variable: 'escore'},
      {axis:"Last_Month",value:3.29, drug_type: 'cannabis', gender: 'M', variable: 'escore'},
      {axis:"Last_Week",value:3.51, drug_type: 'cannabis', gender: 'M', variable: 'escore'},
      {axis:"Last_Year",value:3.12, drug_type: 'cannabis', gender: 'M', variable: 'escore'},
      ]
  ...
  var a_data = [
    [
      ...
      {axis:"Last_Day",value:3.51, drug_type: 'cannabis', gender: 'F', variable: 'ascore'},
      {axis:"Last_Decade",value:3.56, drug_type: 'cannabis', gender: 'F', variable: 'ascore'},
      {axis:"Last_Month",value:3.49, drug_type: 'cannabis', gender: 'F', variable: 'ascore'},
      {axis:"Last_Week",value:3.65, drug_type: 'cannabis', gender: 'F', variable: 'ascore'},
      {axis:"Last_Year",value:3.53, drug_type: 'cannabis', gender: 'F', variable: 'ascore'},
      ],[
      {axis:"Last_Day",value:3.19, drug_type: 'cannabis', gender: 'M', variable: 'ascore'},
      {axis:"Last_Decade",value:3.04, drug_type: 'cannabis', gender: 'M', variable: 'ascore'},
      {axis:"Last_Month",value:3.16, drug_type: 'cannabis', gender: 'M', variable: 'ascore'},
      {axis:"Last_Week",value:3.35, drug_type: 'cannabis', gender: 'M', variable: 'ascore'},
      {axis:"Last_Year",value:3.23, drug_type: 'cannabis', gender: 'M', variable: 'ascore'},
      ]
  ...
  var n_data = [
    [
      {axis:"Last_Day",value:3.67, drug_type: 'cannabis', gender: 'F', variable: 'nscore'},
      {axis:"Last_Decade",value:3.58, drug_type: 'cannabis', gender: 'F', variable: 'nscore'},
      {axis:"Last_Month",value:3.61, drug_type: 'cannabis', gender: 'F', variable: 'nscore'},
      {axis:"Last_Week",value:3.70, drug_type: 'cannabis', gender: 'F', variable: 'nscore'},
      {axis:"Last_Year",value:3.81, drug_type: 'cannabis', gender: 'F', variable: 'nscore'},
  ],[
      {axis:"Last_Day",value:3.43, drug_type: 'cannabis', gender: 'M', variable: 'nscore'},
      {axis:"Last_Decade",value:3.48, drug_type: 'cannabis', gender: 'M', variable: 'nscore'},
      {axis:"Last_Month",value:3.55, drug_type: 'cannabis', gender: 'M', variable: 'nscore'},
      {axis:"Last_Week",value:3.43, drug_type: 'cannabis', gender: 'M', variable: 'nscore'},
      {axis:"Last_Year",value:3.61, drug_type: 'cannabis', gender: 'M', variable: 'nscore'},
  ]
  ];
