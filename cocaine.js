  ...
  d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_hist.csv").then( function(data) {
    ...
    const svg = d3.select("#cocaine-description")
    .append("svg")
  ...
  // Add the path using this helper function
    ...
    .text('Personality Scores Analysis of cocaine Users');

    var text1 = "Analyzing personality scores of cocaine users. \n The section covers personality score distribution among gender, average scores by age and education, and a radar chart showing average scores \n of cocaine users and the period when they last use cocaine.";
...
svg.append("text")
  ...
  .style("font-size", "20px") 
  .style("text-decoration", "underline")
  .text('What is Cocaine?');

  var text2 = "Cocaine is a central nervous system stimulant. As an extract it is mainly used recreationally and often illegally for its euphoric effects."
  svg.append("text")
  .attr("x", 0)
  .attr("y", 190)
  .style("font-size", "14px")
...

{
  ...
  return d.variable === "oscore" && d.gender === "F" && d.drug_type === "cocaine"
  }));
  const bins2 = histogram(data.filter( function(d){
  return d.variable === "cscore" && d.gender === "F" && d.drug_type === "cocaine"
  }));
  const bins3 = histogram(data.filter( function(d){
  return d.variable === "escore" && d.gender === "F" && d.drug_type === "cocaine"
  }));
  const bins4 = histogram(data.filter( function(d){
  return d.variable === "ascore" && d.gender === "F" && d.drug_type === "cocaine"
  }));
  const bins5 = histogram(data.filter( function(d){
  return d.variable === "nscore" && d.gender === "F" && d.drug_type === "cocaine"
  }));
...
// this codde is done for multiple hisograms 
  ...
  // And apply twice this function to data to get the bins.
  const bins1 = histogram(data.filter( function(d){
  return d.variable === "oscore" && d.gender === "M" && d.drug_type === "cocaine"
  }));
  const bins2 = histogram(data.filter( function(d){
  return d.variable === "cscore" && d.gender === "M" && d.drug_type === "cocaine"
  }));
  const bins3 = histogram(data.filter( function(d){
  return d.variable === "escore" && d.gender === "M" && d.drug_type === "cocaine"
  }));
  const bins4 = histogram(data.filter( function(d){
  return d.variable === "ascore" && d.gender === "M" && d.drug_type === "cocaine"
  }));
  const bins5 = histogram(data.filter( function(d){
  return d.variable === "nscore" && d.gender === "M" && d.drug_type === "cocaine"
  }));
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'cocaine').filter(d => d.variable === 'oscore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'cocaine').filter(d => d.variable === 'cscore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'cocaine').filter(d => d.variable === 'escore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'cocaine').filter(d => d.variable === 'ascore');
...
d3.csv("https://raw.githubusercontent.com/ghazalayobi/CS-visual-analytics/main/Final-Project/data/data_bar_age.csv", d => {
  ...
  const data = data_o.filter(d => d.drug_type === 'cocaine').filter(d => d.variable === 'nscore');
...
/////////////////////////////////////////
  ...
  var c_data = [
    ...
    [
      {axis:"Last_Day",value:3.22, drug_type: 'cocaine', gender: 'F', variable: 'cscore'},
      {axis:"Last_Decade",value:3.35, drug_type: 'cocaine', gender: 'F', variable: 'cscore'},
      {axis:"Last_Month",value:3.22, drug_type: 'cocaine', gender: 'F', variable: 'cscore'},
      {axis:"Last_Week",value:2.93, drug_type: 'cocaine', gender: 'F', variable: 'cscore'},
      {axis:"Last_Year",value:3.25, drug_type: 'cocaine', gender: 'F', variable: 'cscore'},
  ],[
      {axis:"Last_Day",value:3.52, drug_type: 'cocaine', gender: 'M', variable: 'cscore'},
      {axis:"Last_Decade",value:3.23, drug_type: 'cocaine', gender: 'M', variable: 'cscore'},
      {axis:"Last_Month",value:3.21, drug_type: 'cocaine', gender: 'M', variable: 'cscore'},
      {axis:"Last_Week",value:3.03, drug_type: 'cocaine', gender: 'M', variable: 'cscore'},
      {axis:"Last_Year",value:3.05, drug_type: 'cocaine', gender: 'M', variable: 'cscore'},
  ]
  ];
  ...
  var e_data = [
    ...
    [
      {axis:"Last_Day",value:2.75, drug_type: 'cocaine', gender: 'F', variable: 'escore'},
      {axis:"Last_Week",value:3.47, drug_type: 'cocaine', gender: 'F', variable: 'escore'},
      {axis:"Last_Month",value:3.59, drug_type: 'cocaine', gender: 'F', variable: 'escore'},
      {axis:"Last_Year",value:4.16, drug_type: 'cocaine', gender: 'F', variable: 'escore'},
      {axis:"Last_Decade",value:3.66, drug_type: 'cocaine', gender: 'F', variable: 'escore'},
  ],[
      {axis:"Last_Day",value:3.77, drug_type: 'cocaine', gender: 'M', variable: 'escore'},
      {axis:"Last_Week",value:3.31, drug_type: 'cocaine', gender: 'M', variable: 'escore'},
      {axis:"Last_Month",value:3.57, drug_type: 'cocaine', gender: 'M', variable: 'escore'},
      {axis:"Last_Year",value:3.56, drug_type: 'cocaine', gender: 'M', variable: 'escore'},
      {axis:"Last_Decade",value:3.47, drug_type: 'cocaine', gender: 'M', variable: 'escore'},
  ]
  ...
  var a_data = [
    [
      {axis:"Last_Day",value:2.41, drug_type: 'cocaine', gender: 'F', variable: 'ascore'},
      {axis:"Last_Decade",value:3.6, drug_type: 'cocaine', gender: 'F', variable: 'ascore'},
      {axis:"Last_Month",value:3.2, drug_type: 'cocaine', gender: 'F', variable: 'ascore'},
      {axis:"Last_Week",value:3.13, drug_type: 'cocaine', gender: 'F', variable: 'ascore'},
      {axis:"Last_Year",value:3.37, drug_type: 'cocaine', gender: 'F', variable: 'ascore'},
  ],[
      {axis:"Last_Day",value:2.75, drug_type: 'cocaine', gender: 'M', variable: 'ascore'},
      {axis:"Last_Decade",value:3.16, drug_type: 'cocaine', gender: 'M', variable: 'ascore'},
      {axis:"Last_Month",value:3.14, drug_type: 'cocaine', gender: 'M', variable: 'ascore'},
      {axis:"Last_Week",value:2.85, drug_type: 'cocaine', gender: 'M', variable: 'ascore'},
      {axis:"Last_Year",value:3.13, drug_type: 'cocaine', gender: 'M', variable: 'ascore'},
  ]
  ...
  var n_data = [
    ...
    [
      {axis:"Last_Day",value:3.4, drug_type: 'cocaine', gender: 'M', variable: 'nscore'},
      {axis:"Last_Decade",value:3.52, drug_type: 'cocaine', gender: 'M', variable: 'nscore'},
      {axis:"Last_Month",value:3.58, drug_type: 'cocaine', gender: 'M', variable: 'nscore'},
      {axis:"Last_Week",value:3.66, drug_type: 'cocaine', gender: 'M', variable: 'nscore'},
      {axis:"Last_Year",value:3.56, drug_type: 'cocaine', gender: 'M', variable: 'nscore'},
  ],[
      {axis:"Last_Day",value:3.93, drug_type: 'cocaine', gender: 'F', variable: 'oscore'},
      {axis:"Last_Decade",value:3.57, drug_type: 'cocaine', gender: 'F', variable: 'oscore'},
      {axis:"Last_Month",value:3.67, drug_type: 'cocaine', gender: 'F', variable: 'oscore'},
      {axis:"Last_Week",value:3.76, drug_type: 'cocaine', gender: 'F', variable: 'oscore'},
      {axis:"Last_Year",value:3.7, drug_type: 'cocaine', gender: 'F', variable: 'oscore'},
  ]
